...
def filter(wavpath, out_dir, expand=False):
    ...
    save_path = os.path.join(out_dir, wav_name[:-4] + "-VAD" + ".wav")
    write_wave(save_path, voiced_frames, sample_rate)


if __name__ == "__main__":
    in_wave = r"C:\Users\Lollipop\Desktop\语音数据测试\test\output\AHvqxmTD_cough-48K.wav"
    outdir = r"C:\Users\Lollipop\Desktop\语音数据测试\test\output"
    filter(in_wave, outdir, expand=False)
