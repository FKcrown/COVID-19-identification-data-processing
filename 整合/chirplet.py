...
class FCT:
    ...
    Attributes :
        ...
        _num_octaves : the number of octaves(音调)
        _num_chirps_by_octave : the number of chirps by octave
        _polynome_degree : degree of the polynomial function（多项式函数的度？）
    ...
    def __init__(self,
        ...
        Args:
            ...
            num_octaves : the number of octaves（J）
            num_chirps_by_octave : the number of chirps by octave（Q 每个音阶的小波数）
...
def apply_filterbank(input_signal, chirplets, end_smoothing):
    ...
    Params :
        ...
        end_smoothing : relative to the length of the output signal
    Returns :
        fast chirplet transform of the signal to all the frequency domain
    """
